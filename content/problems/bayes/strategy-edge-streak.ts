...
export const strategyEdgeStreak: ProblemTemplate = {
  ...
  solution: (p, d) => [
    ...
    { title: "Posterior", body: `Masses: $0.5\\times${fmtNum(d.likeH1)}=${fmtNum(d.massH1)}$ and $0.5\\times${fmtNum(d.likeH0)}=${fmtNum(d.massH0)}$. So $P(E\\mid\\text{record})=${fmtNum(d.massH1)}/(${fmtNum(d.massH1)}+${fmtNum(d.massH0)})=${fmtNum(d.posterior)}$.` },
