...
export const varianceOfAFittedValue: ProblemTemplate = {
  ...
  keyInsight: "A fitted line has a waist: it is pinned tightest at the point of means and widens on both sides, because the uncertainty in its tilt costs nothing at the centre and grows with the square of the distance from it. That shape is the whole argument against extrapolation — the formula keeps returning an answer long after the data has stopped supporting one.",
